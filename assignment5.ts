...
/** 4- -Write a program that defines a function to calculate the area of a circle. The function 
should take the radius as input and return the calculated area.**/
...
/** 5-Develop a program that reads a list of grades and uses the splice method 
