...
console.log("Conversion of Celcius to Farenheit is",CtoFtemp);
//farenheit to celcius
var FtoCtemp:number=temp-32*(5/9);
console.log("Conversion of Farenheit to Celcius is",FtoCtemp);

//Q2) - Write a program that calculates the percentage.
var obtainedMarks:number=1065;
var totalMarks:number=1100;
var result:number=obtainedMarks/totalMarks*100;
console.log("The percentage of marks is",result);
...
var temp1:number=41;
if(temp1<32){
    console.log("It is cold, wear warm cloths.");
}
else{
  console.log("It is warm, wear light cloths.");
}
...
if(num%3==0 && num%5==0){
  ...
  console.log("It's not divisible by 3 or 5");
}
...
var day6:number=6;
var day7:number=7;
console.log("Give a number from 1 to 7 and I'll tell you what day is it?");
if(day1==1){
